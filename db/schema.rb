...
ActiveRecord::Schema.define(:version => 20130708035400) do
  ...
  add_index "archivos", ["url_id"], :name => "index_archivos_on_url_id"
  ...
  add_index "denuncias", ["dependencia_id"], :name => "index_denuncias_on_dependencia_id"
